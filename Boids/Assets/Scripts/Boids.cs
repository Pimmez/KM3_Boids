...
public class Boids : MonoBehaviour
	{
		...
		private void SetTrajectoryUpdate()
		{
			switch (boidType)
			{
		...
		private void AutonomousUpdateTrajectory()
		{
		...
		private void ManagedUpdateTrajectory()
		{
			_separation = Vector3.zero;
			_alignment = Vector3.zero;
		...
		private void DetectedGameObjectResponse(GameObject gameObj)
		{
